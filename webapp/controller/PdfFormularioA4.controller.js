sap.ui.define([
		...
		return BaseController.extend("agile.pesagembobina.controller.PdfFormularioA4", {
			 ...
			 */
			onInit : function () {
				this.getRouter().getRoute("pdfFormularioA4").attachPatternMatched(this._onObjectMatched, this);
			},
