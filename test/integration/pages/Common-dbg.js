sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("agile/pesagembobina/app", ".html");
		...
		return Opa5.extend("agile.pesagembobina.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["agile/pesagembobina/localService/mockserver"], function (mockserver) {
