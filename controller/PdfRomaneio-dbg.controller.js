sap.ui.define([
	...
	return BaseController.extend("agile.pesagembobina.controller.PdfRomaneio", {
		 ...
		 */
		onInit: function () {
			this.getRouter().getRoute("pdfRomaneio").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		_onObjectMatched: function (oEvent) {
			...
			if (_url) {
				...
				oHtml.setContent("<iframe id='ifrmPdf' scrolling='no' src=" + sPdfURL + " width='100%' height='100%'></iframe>");
